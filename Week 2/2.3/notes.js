...
// installed ubuntu and used it's terminal->
...
// to write something in a file-> vi   {but to write in it press 'i' , it will go in insert mode, now u can write, then to exit press 'esc', this will escape the insert mode then type-> :q!  then press enter, & you're out of the vim}
